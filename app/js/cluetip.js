            ...
            error: function(xhr, textStatus) {
              if (isActive) {
                if (optionError) {
                  ...
                  $cluetipInner.html('<i>sorry, andmeid ei saa laadida</i>');
                }
              }
            },
 ...
 */
  ...
  $.fn.cluetip.defaults = {  // set up default options
    width:            450,      // The width of the clueTip
    ...
    closeText:        'Sulge',  // text (or HTML) to to be clicked to close sticky clueTips
